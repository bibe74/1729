...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			...
			CASE WHEN COALESCE(SFEB.DatiGenerali_DatiGeneraliDocumento_DatiBollo_ImportoBollo, 0.0) > 0.0 THEN SFEB.DatiGenerali_DatiGeneraliDocumento_Arrotondamento ELSE NULL END AS DatiGenerali_DatiGeneraliDocumento_Arrotondamento,
			CASE WHEN COALESCE(SFEB.DatiGenerali_DatiGeneraliDocumento_DatiBollo_ImportoBollo, 0.0) > 0.0 THEN SFEB.DatiGenerali_DatiGeneraliDocumento_Art73 ELSE '' END AS DatiGenerali_DatiGeneraliDocumento_Art73,
