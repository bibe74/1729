...
GO
/**
 * @stored_procedure XMLFatture.ssp_ConvalidaFatturaBody
...
BEGIN
	...
	BEGIN
		...
		EXEC XMLFatture.ssp_VerificaCampoSDI @PKValidazione = @PKValidazione, @IDCampo = N'2.2.1.12', @TipoValore = 'D', @ValoreDecimale = @AliquotaIVA, @NumeroLinea = @NumeroLinea;
	...
	BEGIN
		...
		EXEC XMLFatture.ssp_VerificaCampoSDI @PKValidazione = @PKValidazione, @IDCampo = N'2.2.2.1', @TipoValore = 'D', @ValoreDecimale = @AliquotaIVA;
		...
		EXEC XMLFatture.ssp_VerificaCampoSDI @PKValidazione = @PKValidazione, @IDCampo = N'2.2.2.6', @TipoValore = 'D', @ValoreDecimale = @Imposta;
		EXEC XMLFatture.ssp_VerificaCampoSDI @PKValidazione = @PKValidazione, @IDCampo = N'2.2.2.7', @ValoreTesto = @EsigibilitaIVA, @IsObbligatorio = 0;
		...
		IF (@Natura = 'N6' AND @EsigibilitaIVA = 'S')
		BEGIN
