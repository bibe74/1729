...
/**
 * @stored_procedure XMLFatture.ssp_ConvalidaFatturaHeader
...
BEGIN
	...
	EXEC XMLFatture.ssp_VerificaCampoSDI @PKValidazione = @PKValidazione, @IDCampo = N'1.1.1.2', @ValoreTesto = @DatiTrasmissione_IdTrasmittente_IdCodice;
	...
	EXEC XMLFatture.ssp_VerificaCampoSDI @PKValidazione = @PKValidazione, @IDCampo = N'1.2.1.1.2', @ValoreTesto = @CedentePrestatore_DatiAnagrafici_IdFiscaleIVA_IdCodice;
	EXEC XMLFatture.ssp_VerificaCampoSDI @PKValidazione = @PKValidazione, @IDCampo = N'1.2.1.2', @ValoreTesto = @CedentePrestatore_DatiAnagrafici_CodiceFiscale, @IsObbligatorio = 0;
	...
	EXEC XMLFatture.ssp_VerificaCampoSDI @PKValidazione = @PKValidazione, @IDCampo = N'1.4.1.1.2', @ValoreTesto = @CessionarioCommittente_DatiAnagrafici_IdFiscaleIVA_IdCodice, @IsObbligatorio = 0;
	EXEC XMLFatture.ssp_VerificaCampoSDI @PKValidazione = @PKValidazione, @IDCampo = N'1.4.1.2', @ValoreTesto = @CessionarioCommittente_DatiAnagrafici_CodiceFiscale, @IsObbligatorio = 0;
