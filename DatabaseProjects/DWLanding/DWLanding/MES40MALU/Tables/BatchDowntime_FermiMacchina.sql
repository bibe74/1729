CREATE TABLE [MES40MALU].[BatchDowntime_FermiMacchina] (
...
ALTER TABLE [MES40MALU].[BatchDowntime_FermiMacchina]
    ADD CONSTRAINT [PK_BatchDowntime_FermiMacchina] PRIMARY KEY CLUSTERED ([BatchDowntimeID] ASC);
GO

CREATE UNIQUE NONCLUSTERED INDEX [IX_MES40MALU_BatchDowntime_FermiMacchina_DowntimeType_BatchDowntimeID]
    ON [MES40MALU].[BatchDowntime_FermiMacchina]([DowntimeType] ASC, [BatchDowntimeID] ASC);
GO
