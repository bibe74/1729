CREATE TABLE [MES40MALU].[BatchBillet_Billette] (
...
CREATE NONCLUSTERED INDEX [IX_MES40MALU_BatchBillet_Billette_StartTs_INCLUDE]
    ON [MES40MALU].[BatchBillet_Billette]([StartTs] ASC)
    INCLUDE([BatchID], [BilletNo]);
GO

ALTER TABLE [MES40MALU].[BatchBillet_Billette]
