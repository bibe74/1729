...
CREATE PROCEDURE MES40MALU.usp_Merge_BatchScrapShear_ScartiCesoia
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'MES40MALU.BatchScrapShear_ScartiCesoia', N'U') IS NULL
BEGIN
    EXEC MES40MALU.usp_Create_BatchScrapShear_ScartiCesoia;
    EXEC MES40MALU.usp_AddIndexes_BatchScrapShear_ScartiCesoia;
END;

MERGE INTO MES40MALU.BatchScrapShear_ScartiCesoia AS TGT
USING MES40MALU.BatchScrapShear_ScartiCesoiaView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40MALU.BatchScrapShear_ScartiCesoia' AS full_olap_table_name,
