...
CREATE PROCEDURE MES40MALU.usp_Merge_Batch_Lotti
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'MES40MALU.Batch_Lotti', N'U') IS NULL
BEGIN
    EXEC MES40MALU.usp_Create_Batch_Lotti;
    EXEC MES40MALU.usp_AddIndexes_Batch_Lotti;
END;

MERGE INTO MES40MALU.Batch_Lotti AS TGT
USING MES40MALU.Batch_LottiView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40MALU.Batch_Lotti' AS full_olap_table_name,
