...
CREATE PROCEDURE MES40MALU.usp_Merge_BatchDowntime_FermiMacchinaNew
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MES40MALU.BatchDowntime_FermiMacchinaNew', 'U') IS NULL
BEGIN
    EXEC MES40MALU.usp_Create_BatchDowntime_FermiMacchinaNew;
    EXEC MES40MALU.usp_AddIndexes_BatchDowntime_FermiMacchinaNew;
END;

MERGE INTO MES40MALU.BatchDowntime_FermiMacchinaNew AS TGT
USING MES40MALU.BatchDowntime_FermiMacchinaNewView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40MALU.BatchDowntime_FermiMacchinaNew' AS full_olap_table_name,
