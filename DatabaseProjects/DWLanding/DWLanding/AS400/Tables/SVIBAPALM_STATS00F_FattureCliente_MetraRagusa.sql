CREATE TABLE [AS400].[SVIBAPALM_STATS00F_FattureCliente_MetraRagusa] (
    ...
    [PKFattureCliente_MetraRagusa] BIGINT          NOT NULL,
...
CREATE STATISTICS [STNBO]
    ON [AS400].[SVIBAPALM_STATS00F_FattureCliente_MetraRagusa]([STNBO]);
GO

CREATE STATISTICS [STRIO]
    ON [AS400].[SVIBAPALM_STATS00F_FattureCliente_MetraRagusa]([STRIO]);
GO

CREATE STATISTICS [PKFattureCliente_MetraRagusa]
    ON [AS400].[SVIBAPALM_STATS00F_FattureCliente_MetraRagusa]([PKFattureCliente_MetraRagusa]);
GO

CREATE STATISTICS [STDBO]
    ON [AS400].[SVIBAPALM_STATS00F_FattureCliente_MetraRagusa]([STDBO]);
GO

CREATE STATISTICS [STNUO]
    ON [AS400].[SVIBAPALM_STATS00F_FattureCliente_MetraRagusa]([STNUO]);
GO

ALTER TABLE [AS400].[SVIBAPALM_STATS00F_FattureCliente_MetraRagusa]
    ADD CONSTRAINT [PK_AS400_SVIBAPALM_STATS00F_FattureCliente_MetraRagusa] PRIMARY KEY CLUSTERED ([STDFA] ASC, [STNFA] ASC, [STNUO] ASC, [STRIO] ASC, [STDBO] ASC, [STNBO] ASC, [PKFattureCliente_MetraRagusa] ASC);
GO
