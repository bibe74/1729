CREATE TABLE [AS400].[MEDEP_KK_BFAGE00F_GruppoVendite_MetraSistemi] (
...
ALTER TABLE [AS400].[MEDEP_KK_BFAGE00F_GruppoVendite_MetraSistemi]
    ADD CONSTRAINT [PK_AS400_MEDEP_KK_BFAGE00F_GruppoVendite_MetraSistemi] PRIMARY KEY CLUSTERED ([CDAGE] ASC);
GO
