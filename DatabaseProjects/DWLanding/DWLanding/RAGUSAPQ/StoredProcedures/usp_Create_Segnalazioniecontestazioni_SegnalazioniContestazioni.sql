...
CREATE PROCEDURE RAGUSAPQ.usp_Create_Segnalazioniecontestazioni_SegnalazioniContestazioni
AS
BEGIN
SET NOCOUNT ON;

CREATE TABLE RAGUSAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni (
    -- Chiavi
    Numero        INT NOT NULL,
