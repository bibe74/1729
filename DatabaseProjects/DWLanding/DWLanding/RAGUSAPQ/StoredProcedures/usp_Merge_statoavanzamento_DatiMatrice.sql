...
CREATE PROCEDURE RAGUSAPQ.usp_Merge_statoavanzamento_DatiMatrice
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'RAGUSAPQ.statoavanzamento_DatiMatrice', N'U') IS NULL
BEGIN
	EXEC RAGUSAPQ.usp_Create_statoavanzamento_DatiMatrice;
	EXEC RAGUSAPQ.usp_AddIndexes_statoavanzamento_DatiMatrice;
END;

MERGE INTO RAGUSAPQ.statoavanzamento_DatiMatrice AS TGT
USING RAGUSAPQ.statoavanzamento_DatiMatriceView (nolock) AS SRC
...
OUTPUT
	...
	'RAGUSAPQ.statoavanzamento_DatiMatrice' AS full_olap_table_name,
