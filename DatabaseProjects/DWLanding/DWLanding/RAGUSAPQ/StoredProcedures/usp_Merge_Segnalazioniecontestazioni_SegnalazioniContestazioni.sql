...
CREATE PROCEDURE RAGUSAPQ.usp_Merge_Segnalazioniecontestazioni_SegnalazioniContestazioni
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'RAGUSAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni', N'U') IS NULL
BEGIN
    EXEC RAGUSAPQ.usp_Create_Segnalazioniecontestazioni_SegnalazioniContestazioni;
    EXEC RAGUSAPQ.usp_AddIndexes_Segnalazioniecontestazioni_SegnalazioniContestazioni;
END;

TRUNCATE TABLE RAGUSAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni;

MERGE INTO RAGUSAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni AS TGT
USING RAGUSAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioniView (nolock) AS SRC
...
OUTPUT
    ...
    'RAGUSAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni' AS full_olap_table_name,
