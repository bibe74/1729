CREATE VIEW MRDP.FermiMacchina_FermiMacchinaView
AS
SELECT
...
FROM [SQL2014\SCADA2014].RaccoltaDatiProduzione.dbo.FermiMacchina FM
LEFT JOIN [SQL2014\SCADA2014].RaccoltaDatiProduzione.dbo.CausaliFermoMacchina CFM ON CFM.ID = FM.IDCausaleFermoMacchina
LEFT JOIN [SQL2014\SCADA2014].RaccoltaDatiProduzione.dbo.FermiMacchina_TipiGuasto TG ON TG.ID = FM.TipoGuasto
...
FROM [SQL2014\SCADA2014].RaccoltaDatiProduzione.dbo.FermiMacchina_Micro FMM
LEFT JOIN [SQL2014\SCADA2014].RaccoltaDatiProduzione.dbo.CausaliMicrofermoMacchina CFMM ON CFMM.ID = FMM.IDCausaleMicroFermoMacchina
