...
CREATE PROCEDURE MRDP.usp_Merge_RaccoltaDatiTaglierina_DatiIncestamento
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'MRDP.RaccoltaDatiTaglierina_DatiIncestamento', N'U') IS NULL
BEGIN
	EXEC MRDP.usp_Create_RaccoltaDatiTaglierina_DatiIncestamento;
	EXEC MRDP.usp_AddIndexes_RaccoltaDatiTaglierina_DatiIncestamento;
END;

MERGE INTO MRDP.RaccoltaDatiTaglierina_DatiIncestamento AS TGT
USING MRDP.RaccoltaDatiTaglierina_DatiIncestamentoView (nolock) AS SRC
...
OUTPUT
	...
	'MRDP.RaccoltaDatiTaglierina_DatiIncestamento' AS full_olap_table_name,
