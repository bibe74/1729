...
CREATE PROCEDURE MRDP.usp_Merge_FermiMacchina_FermiMacchina
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MRDP.FermiMacchina_FermiMacchina', 'U') IS NULL
BEGIN
    EXEC MRDP.usp_Create_FermiMacchina_FermiMacchina;
    EXEC MRDP.usp_AddIndexes_FermiMacchina_FermiMacchina;
END;

MERGE INTO MRDP.FermiMacchina_FermiMacchina AS TGT
USING MRDP.FermiMacchina_FermiMacchinaView (nolock) AS SRC
...
OUTPUT
    ...
    'MRDP.FermiMacchina_FermiMacchina' AS full_olap_table_name,
