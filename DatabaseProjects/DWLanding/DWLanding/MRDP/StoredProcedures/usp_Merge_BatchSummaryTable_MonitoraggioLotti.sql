...
CREATE PROCEDURE MRDP.usp_Merge_BatchSummaryTable_MonitoraggioLotti
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MRDP.BatchSummaryTable_MonitoraggioLotti', N'U') IS NULL
BEGIN
    EXEC MRDP.usp_Create_BatchSummaryTable_MonitoraggioLotti;
    EXEC MRDP.usp_AddIndexes_BatchSummaryTable_MonitoraggioLotti;
END;

MERGE INTO MRDP.BatchSummaryTable_MonitoraggioLotti AS TGT
USING MRDP.BatchSummaryTable_MonitoraggioLottiView (nolock) AS SRC
...
OUTPUT
    ...
    'MRDP.BatchSummaryTable_MonitoraggioLotti' AS full_olap_table_name,
