...
CREATE PROCEDURE MRDP.usp_Merge_RaccoltaDatiLotto_Lotti_Lotti
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'MRDP.RaccoltaDatiLotto_Lotti_Lotti', N'U') IS NULL
BEGIN
	EXEC MRDP.usp_Create_RaccoltaDatiLotto_Lotti_Lotti;
	EXEC MRDP.usp_AddIndexes_RaccoltaDatiLotto_Lotti_Lotti;
END;

MERGE INTO MRDP.RaccoltaDatiLotto_Lotti_Lotti AS TGT
USING MRDP.RaccoltaDatiLotto_Lotti_LottiView (nolock) AS SRC
...
OUTPUT
	...
	'MRDP.RaccoltaDatiLotto_Lotti_Lotti' AS full_olap_table_name,
