...
CREATE PROCEDURE MRDP.usp_Merge_PressSummaryTable_MonitoraggioPresse
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MRDP.PressSummaryTable_MonitoraggioPresse', N'U') IS NULL
BEGIN
    EXEC MRDP.usp_Create_PressSummaryTable_MonitoraggioPresse;
    EXEC MRDP.usp_AddIndexes_PressSummaryTable_MonitoraggioPresse;
END;

MERGE INTO MRDP.PressSummaryTable_MonitoraggioPresse AS TGT
USING MRDP.PressSummaryTable_MonitoraggioPresseView (nolock) AS SRC
...
OUTPUT
    ...
    'MRDP.PressSummaryTable_MonitoraggioPresse' AS full_olap_table_name,
