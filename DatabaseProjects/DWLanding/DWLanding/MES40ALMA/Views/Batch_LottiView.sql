...
CREATE VIEW MES40ALMA.Batch_LottiView
AS
SELECT
    -- Chiavi
    ...
    CONVERT(DATETIME, PressClosedTs) AS PressClosedTs,        -- ChiusuraLottoDataOra
...
FROM [192.168.216.247\SCADA2017].ALMA_MES40_RDP.BI.vBatch;
GO
