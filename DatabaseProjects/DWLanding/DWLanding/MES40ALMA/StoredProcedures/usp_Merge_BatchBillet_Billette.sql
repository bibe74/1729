...
CREATE PROCEDURE MES40ALMA.usp_Merge_BatchBillet_Billette
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MES40ALMA.BatchBillet_Billette', 'U') IS NULL
BEGIN
    EXEC MES40ALMA.usp_Create_BatchBillet_Billette;
    EXEC MES40ALMA.usp_AddIndexes_BatchBillet_Billette;
END;

MERGE INTO MES40ALMA.BatchBillet_Billette AS TGT
USING MES40ALMA.BatchBillet_BilletteView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40ALMA.BatchBillet_Billette' AS full_olap_table_name,
