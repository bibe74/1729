...
CREATE PROCEDURE MES40ALMA.usp_Merge_BatchDowntime_FermiMacchinaNew
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MES40ALMA.BatchDowntime_FermiMacchinaNew', 'U') IS NULL
BEGIN
    EXEC MES40ALMA.usp_Create_BatchDowntime_FermiMacchinaNew;
    EXEC MES40ALMA.usp_AddIndexes_BatchDowntime_FermiMacchinaNew;
END;

MERGE INTO MES40ALMA.BatchDowntime_FermiMacchinaNew AS TGT
USING MES40ALMA.BatchDowntime_FermiMacchinaNewView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40ALMA.BatchDowntime_FermiMacchinaNew' AS full_olap_table_name,
