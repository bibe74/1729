...
CREATE PROCEDURE MES40ALMA.usp_Merge_Batch_Lotti
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MES40ALMA.Batch_Lotti', 'U') IS NULL
BEGIN
    EXEC MES40ALMA.usp_Create_Batch_Lotti;
    EXEC MES40ALMA.usp_AddIndexes_Batch_Lotti;
END;

MERGE INTO MES40ALMA.Batch_Lotti AS TGT
USING MES40ALMA.Batch_LottiView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40ALMA.Batch_Lotti' AS full_olap_table_name,
