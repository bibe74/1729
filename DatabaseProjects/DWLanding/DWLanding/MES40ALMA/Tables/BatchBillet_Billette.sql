CREATE TABLE [MES40ALMA].[BatchBillet_Billette] (
...
CREATE NONCLUSTERED INDEX [IX_MES40ALMA_BatchBillet_Billette_StartTs_INCLUDE]
    ON [MES40ALMA].[BatchBillet_Billette]([StartTs] ASC)
    INCLUDE([BatchID], [BilletNo]);
GO

ALTER TABLE [MES40ALMA].[BatchBillet_Billette]
