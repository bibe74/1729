CREATE   VIEW setup.all_columns_SyncMetra
AS
/*
...
AS (
	...
	INNER JOIN setup.tables_AX2009 T ON C.full_table_name = T.full_table_name
	...
	INNER JOIN setup.tables_EDMSRV64 T ON C.full_table_name = T.full_table_name
	...
	INNER JOIN setup.tables_IMETPQ T ON C.full_table_name = T.full_table_name
	...
	INNER JOIN setup.tables_IRDP T ON C.full_table_name = T.full_table_name
	...
	INNER JOIN setup.tables_MERIDIANSQL T ON C.full_table_name = T.full_table_name
	...
	INNER JOIN setup.tables_METRADTE T ON C.full_table_name = T.full_table_name
	...
	INNER JOIN setup.tables_METRAPQ T ON C.full_table_name = T.full_table_name
	...
	INNER JOIN setup.tables_MRDA T ON C.full_table_name = T.full_table_name
	...
	INNER JOIN setup.tables_MRDP T ON C.full_table_name = T.full_table_name
	...
	INNER JOIN setup.tables_RAGUSAPQ T ON C.full_table_name = T.full_table_name
	...
	INNER JOIN setup.tables_STATISTICHE T ON C.full_table_name = T.full_table_name
)
SELECT
	AC.schema_name,
	AC.full_table_name,
