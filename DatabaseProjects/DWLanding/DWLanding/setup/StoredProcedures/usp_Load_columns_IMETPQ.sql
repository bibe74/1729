...
CREATE PROCEDURE setup.usp_Load_columns_IMETPQ
AS
BEGIN

SET NOCOUNT ON;

IF OBJECT_ID(N'setup.columns_IMETPQ', N'U') IS NULL
BEGIN
	EXEC setup.usp_Create_columns_IMETPQ;
END;
...
MERGE INTO setup.columns_IMETPQ AS TGT
USING (
	SELECT
