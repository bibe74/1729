...
CREATE PROCEDURE setup.usp_Load_columns_MERIDIANSQL
AS
BEGIN

SET NOCOUNT ON;

IF OBJECT_ID(N'setup.columns_MERIDIANSQL', N'U') IS NULL
BEGIN
	EXEC setup.usp_Create_columns_MERIDIANSQL;
END;
...
MERGE INTO setup.columns_MERIDIANSQL AS TGT
USING (
	SELECT
...
UPDATE setup.columns_MERIDIANSQL
