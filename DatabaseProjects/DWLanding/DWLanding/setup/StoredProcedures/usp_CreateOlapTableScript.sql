CREATE PROCEDURE setup.usp_CreateOlapTableScript
(
...
--IF OBJECT_ID('#statement_lines', 'U') IS NOT NULL DROP TABLE #statement_lines;
BEGIN TRY
...
INSERT INTO #statement_lines (statement_line)
SELECT N'IF OBJECT_ID(''' + @full_olap_table_name + N'View'', N''V'') IS NULL EXEC(''CREATE VIEW ' + @full_olap_table_name + N'View AS SELECT 1 AS fld;'');'
...
INSERT INTO #statement_lines (statement_line)
SELECT N'IF OBJECT_ID(''' + @full_staging_table_name + N'View'', N''V'') IS NULL EXEC(''CREATE VIEW ' + @full_staging_table_name + N'View AS SELECT 1 AS fld;'');'
UNION ALL SELECT N'GO'
UNION ALL SELECT N''
;
INSERT INTO #statement_lines (statement_line)
...
UNION ALL SELECT N'GO'
UNION ALL SELECT N''
UNION ALL SELECT N'IF OBJECT_ID(''' + @full_staging_table_name + N''', N''U'') IS NULL'
...
UNION ALL SELECT N'GO'
UNION ALL SELECT N''
UNION ALL SELECT N'EXEC audit.usp_reload_table @schema_name = N''' + REPLACE(@full_staging_table_name, N'.', N''', @table_name = N''') + N''', @PKEventSubElaboration = NULL;'
UNION ALL SELECT N'GO'
UNION ALL SELECT N''
;
...
INSERT INTO #statement_lines (statement_line)
SELECT N'IF OBJECT_ID(''' + @schema_name + N'.usp_Create_' + @olap_table_name_stripped + N''', N''P'') IS NULL EXEC (''CREATE PROCEDURE ' + @schema_name + N'.usp_Create_' + @olap_table_name_stripped + N' AS RETURN 0;'');'
UNION ALL SELECT N'GO'
UNION ALL SELECT N''
;
...
UNION ALL SELECT N''
--UNION ALL SELECT N'IF OBJECT_ID(''' + @full_olap_table_name + N''', N''U'') IS NOT NULL DROP TABLE ' + @full_olap_table_name + N';'
--UNION ALL SELECT N''
...
INSERT INTO #statement_lines (statement_line)
SELECT N'IF OBJECT_ID(''' + @schema_name + N'.usp_AddIndexes_' + @olap_table_name_stripped + N''', N''P'') IS NULL EXEC(''CREATE PROCEDURE ' + @schema_name + N'.usp_AddIndexes_' + @olap_table_name_stripped + N' AS RETURN 0;'');'
UNION ALL SELECT N'GO'
UNION ALL SELECT N''
;
...
INSERT INTO #statement_lines (statement_line)
SELECT N'IF OBJECT_ID(''' + @schema_name + N'.usp_Merge_' + @olap_table_name_stripped + N''', N''P'') IS NULL EXEC(''CREATE PROCEDURE ' + @schema_name + N'.usp_Merge_' + @olap_table_name_stripped + N' AS RETURN 0;'');'
UNION ALL SELECT N'GO'
UNION ALL SELECT N''
;
...
UNION ALL SELECT N'SET NOCOUNT ON;'
UNION ALL SELECT N''
UNION ALL SELECT N'IF OBJECT_ID(''' + @full_olap_table_name + ''', N''U'') IS NULL'
UNION ALL SELECT N'BEGIN'
