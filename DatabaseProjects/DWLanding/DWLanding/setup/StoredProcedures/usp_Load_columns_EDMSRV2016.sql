...
CREATE PROCEDURE setup.usp_Load_columns_EDMSRV2016
AS
BEGIN

SET NOCOUNT ON;

IF OBJECT_ID(N'setup.columns_EDMSRV2016', N'U') IS NULL
BEGIN
	EXEC setup.usp_Create_columns_EDMSRV2016;
END;
...
MERGE INTO setup.columns_EDMSRV2016 AS TGT
USING (
	SELECT
		...
		column_scale,
		is_nullable
	FROM setup.all_columns_BlueCieloEdmTestMetraProgettazioneDataLibrary
) AS SRC
...
UPDATE setup.columns_EDMSRV2016
