...
CREATE PROCEDURE setup.usp_Load_columns_MRDA
AS
BEGIN

SET NOCOUNT ON;

IF OBJECT_ID(N'setup.columns_MRDA', N'U') IS NULL
BEGIN
	EXEC setup.usp_Create_columns_MRDA;
END;
...
MERGE INTO setup.columns_MRDA AS TGT
USING (
	SELECT
