...
CREATE PROCEDURE setup.usp_Load_columns_MES40_RAW
AS
BEGIN

SET NOCOUNT ON;

IF OBJECT_ID('setup.columns_MES40_RAW', 'U') IS NULL
BEGIN
	EXEC setup.usp_Create_columns_MES40_RAW;
END;
...
MERGE INTO setup.columns_MES40_RAW AS TGT
USING (
	SELECT
...
----UPDATE setup.columns_MES40_RAW
