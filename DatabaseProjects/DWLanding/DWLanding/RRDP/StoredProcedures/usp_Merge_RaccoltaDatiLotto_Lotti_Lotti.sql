...
CREATE PROCEDURE RRDP.usp_Merge_RaccoltaDatiLotto_Lotti_Lotti
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'RRDP.RaccoltaDatiLotto_Lotti_Lotti', N'U') IS NULL
BEGIN
	EXEC RRDP.usp_Create_RaccoltaDatiLotto_Lotti_Lotti;
	EXEC RRDP.usp_AddIndexes_RaccoltaDatiLotto_Lotti_Lotti;
END;

MERGE INTO RRDP.RaccoltaDatiLotto_Lotti_Lotti AS TGT
USING RRDP.RaccoltaDatiLotto_Lotti_LottiView (nolock) AS SRC
...
OUTPUT
	...
	'RRDP.RaccoltaDatiLotto_Lotti_Lotti' AS full_olap_table_name,
