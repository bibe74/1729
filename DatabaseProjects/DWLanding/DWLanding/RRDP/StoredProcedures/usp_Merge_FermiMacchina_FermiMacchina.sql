CREATE PROCEDURE RRDP.usp_Merge_FermiMacchina_FermiMacchina
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('RRDP.FermiMacchina_FermiMacchina', 'U') IS NULL
BEGIN
    EXEC RRDP.usp_Create_FermiMacchina_FermiMacchina;
    EXEC RRDP.usp_AddIndexes_FermiMacchina_FermiMacchina;
END;

MERGE INTO RRDP.FermiMacchina_FermiMacchina AS TGT
USING RRDP.FermiMacchina_FermiMacchinaView (nolock) AS SRC
...
OUTPUT
    ...
    'RRDP.FermiMacchina_FermiMacchina' AS full_olap_table_name,
