...
CREATE PROCEDURE RRDP.usp_Merge_RaccoltaDatiLotto_Billette
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'RRDP.RaccoltaDatiLotto_Billette', N'U') IS NULL
BEGIN
	EXEC RRDP.usp_Create_RaccoltaDatiLotto_Billette;
	EXEC RRDP.usp_AddIndexes_RaccoltaDatiLotto_Billette;
END;

MERGE INTO RRDP.RaccoltaDatiLotto_Billette AS TGT
USING RRDP.RaccoltaDatiLotto_BilletteView (nolock) AS SRC
...
OUTPUT
	...
	'RRDP.RaccoltaDatiLotto_Billette' AS full_olap_table_name,
