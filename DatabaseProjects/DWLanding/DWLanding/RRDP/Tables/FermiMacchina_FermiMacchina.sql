CREATE TABLE [RRDP].[FermiMacchina_FermiMacchina] (
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_RRDP_FermiMacchina_FermiMacchina_DowntimeType_BatchDowntimeID]
    ON [RRDP].[FermiMacchina_FermiMacchina]([DowntimeType] ASC, [BatchDowntimeID] ASC);
GO

ALTER TABLE [RRDP].[FermiMacchina_FermiMacchina]
