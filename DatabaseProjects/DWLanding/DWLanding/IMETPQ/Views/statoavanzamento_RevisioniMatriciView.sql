...
/**
 * @table IMETPQ.statoavanzamento_RevisioniMatrici
 * @description 
...
CREATE   VIEW IMETPQ.statoavanzamento_RevisioniMatriciView
AS
...
AS (
    ...
    FROM [SQL2012IMET\DB2012].MetraPQ.[dbo].[stato avanzamento] SA
)
SELECT
    RM.[N°],
    RM.[Codice Metra],
