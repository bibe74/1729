...
CREATE PROCEDURE IMETPQ.usp_Merge_FogliodiproduzionegiornalieraFoall_DatiColata
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'IMETPQ.FogliodiproduzionegiornalieraFoall_DatiColata', N'U') IS NULL
BEGIN
 EXEC IMETPQ.usp_Create_FogliodiproduzionegiornalieraFoall_DatiColata;
 EXEC IMETPQ.usp_AddIndexes_FogliodiproduzionegiornalieraFoall_DatiColata;
END;

MERGE INTO IMETPQ.FogliodiproduzionegiornalieraFoall_DatiColata AS TGT
USING IMETPQ.FogliodiproduzionegiornalieraFoall_DatiColataView (nolock) AS SRC
...
OUTPUT
 ...
 'IMETPQ.FogliodiproduzionegiornalieraFoall_DatiColata' AS full_olap_table_name,
