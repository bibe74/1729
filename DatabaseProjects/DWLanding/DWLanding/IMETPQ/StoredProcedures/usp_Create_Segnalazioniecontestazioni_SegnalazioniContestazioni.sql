...
CREATE PROCEDURE IMETPQ.usp_Create_Segnalazioniecontestazioni_SegnalazioniContestazioni
AS
BEGIN
SET NOCOUNT ON;

CREATE TABLE IMETPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni (
    -- Chiavi
    Numero        INT NOT NULL,
