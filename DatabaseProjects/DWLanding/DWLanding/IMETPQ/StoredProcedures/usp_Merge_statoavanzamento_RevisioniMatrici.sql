...
CREATE PROCEDURE IMETPQ.usp_Merge_statoavanzamento_RevisioniMatrici
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('IMETPQ.statoavanzamento_RevisioniMatrici', 'U') IS NULL
BEGIN
	EXEC IMETPQ.usp_Create_statoavanzamento_RevisioniMatrici;
	EXEC IMETPQ.usp_AddIndexes_statoavanzamento_RevisioniMatrici;
END;

MERGE INTO IMETPQ.statoavanzamento_RevisioniMatrici AS TGT
USING IMETPQ.statoavanzamento_RevisioniMatriciView (nolock) AS SRC
ON SRC.[N°] = TGT.[N°]
...
OUTPUT
	...
	'IMETPQ.statoavanzamento_RevisioniMatrici' AS full_olap_table_name,
