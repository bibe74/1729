...
CREATE PROCEDURE MES40IMET.usp_Merge_BatchBillet_Billette
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'MES40IMET.BatchBillet_Billette', N'U') IS NULL
BEGIN
    EXEC MES40IMET.usp_Create_BatchBillet_Billette;
    EXEC MES40IMET.usp_AddIndexes_BatchBillet_Billette;
END;

MERGE INTO MES40IMET.BatchBillet_Billette AS TGT
USING MES40IMET.BatchBillet_BilletteView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40IMET.BatchBillet_Billette' AS full_olap_table_name,
