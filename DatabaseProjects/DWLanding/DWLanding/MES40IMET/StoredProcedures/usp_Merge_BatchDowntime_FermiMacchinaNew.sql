...
CREATE PROCEDURE MES40IMET.usp_Merge_BatchDowntime_FermiMacchinaNew
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MES40IMET.BatchDowntime_FermiMacchinaNew', 'U') IS NULL
BEGIN
    EXEC MES40IMET.usp_Create_BatchDowntime_FermiMacchinaNew;
    EXEC MES40IMET.usp_AddIndexes_BatchDowntime_FermiMacchinaNew;
END;

MERGE INTO MES40IMET.BatchDowntime_FermiMacchinaNew AS TGT
USING MES40IMET.BatchDowntime_FermiMacchinaNewView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40IMET.BatchDowntime_FermiMacchinaNew' AS full_olap_table_name,
