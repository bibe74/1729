...
ALTER TABLE [MES40IMET].[BatchBillet_Billette]
    ADD CONSTRAINT [PK_BatchBillet_Billette] PRIMARY KEY CLUSTERED ([BatchBilletID] ASC);
GO

CREATE NONCLUSTERED INDEX [IX_MES40IMET_BatchBillet_Billette_StartTs_INCLUDE]
    ON [MES40IMET].[BatchBillet_Billette]([StartTs] ASC)
