...
/**
 * @table METRAPQ.statoavanzamento_RevisioniMatrici
 * @description 
...
CREATE   VIEW METRAPQ.statoavanzamento_RevisioniMatriciView
AS
...
AS (
    ...
    FROM [SQL2014\DB2014].MetraPQ.[dbo].[stato avanzamento] SA
)
SELECT
    RM.[N°],
    RM.[Codice Metra],
