...
CREATE PROCEDURE METRAPQ.usp_Merge_Segnalazioniecontestazioni_SegnalazioniContestazioni
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'METRAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni', N'U') IS NULL
BEGIN
    EXEC METRAPQ.usp_Create_Segnalazioniecontestazioni_SegnalazioniContestazioni;
    EXEC METRAPQ.usp_AddIndexes_Segnalazioniecontestazioni_SegnalazioniContestazioni;
END;

TRUNCATE TABLE METRAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni;

MERGE INTO METRAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni AS TGT
USING METRAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioniView (nolock) AS SRC
...
OUTPUT
    ...
    'METRAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni' AS full_olap_table_name,
