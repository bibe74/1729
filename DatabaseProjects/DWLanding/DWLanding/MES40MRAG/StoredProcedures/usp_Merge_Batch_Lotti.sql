...
CREATE PROCEDURE MES40MRAG.usp_Merge_Batch_Lotti
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MES40MRAG.Batch_Lotti', 'U') IS NULL
BEGIN
    EXEC MES40MRAG.usp_Create_Batch_Lotti;
    EXEC MES40MRAG.usp_AddIndexes_Batch_Lotti;
END;

MERGE INTO MES40MRAG.Batch_Lotti AS TGT
USING MES40MRAG.Batch_LottiView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40MRAG.Batch_Lotti' AS full_olap_table_name,
