...
CREATE PROCEDURE MES40MRAG.usp_Merge_BatchScrapShear_ScartiCesoia
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MES40MRAG.BatchScrapShear_ScartiCesoia', 'U') IS NULL
BEGIN
    EXEC MES40MRAG.usp_Create_BatchScrapShear_ScartiCesoia;
    EXEC MES40MRAG.usp_AddIndexes_BatchScrapShear_ScartiCesoia;
END;

MERGE INTO MES40MRAG.BatchScrapShear_ScartiCesoia AS TGT
USING MES40MRAG.BatchScrapShear_ScartiCesoiaView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40MRAG.BatchScrapShear_ScartiCesoia' AS full_olap_table_name,
