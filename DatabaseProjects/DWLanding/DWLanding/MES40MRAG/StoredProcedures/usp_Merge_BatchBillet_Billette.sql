...
CREATE PROCEDURE MES40MRAG.usp_Merge_BatchBillet_Billette
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MES40MRAG.BatchBillet_Billette', 'U') IS NULL
BEGIN
    EXEC MES40MRAG.usp_Create_BatchBillet_Billette;
    EXEC MES40MRAG.usp_AddIndexes_BatchBillet_Billette;
END;

MERGE INTO MES40MRAG.BatchBillet_Billette AS TGT
USING MES40MRAG.BatchBillet_BilletteView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40MRAG.BatchBillet_Billette' AS full_olap_table_name,
