...
CREATE PROCEDURE CANADAPQ.usp_Merge_statoavanzamento_DatiMatrice
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'CANADAPQ.statoavanzamento_DatiMatrice', N'U') IS NULL
BEGIN
	EXEC CANADAPQ.usp_Create_statoavanzamento_DatiMatrice;
	EXEC CANADAPQ.usp_AddIndexes_statoavanzamento_DatiMatrice;
END;

MERGE INTO CANADAPQ.statoavanzamento_DatiMatrice AS TGT
USING CANADAPQ.statoavanzamento_DatiMatriceView (nolock) AS SRC
...
OUTPUT
	...
	'CANADAPQ.statoavanzamento_DatiMatrice' AS full_olap_table_name,
