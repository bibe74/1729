...
CREATE PROCEDURE CANADAPQ.usp_Merge_Segnalazioniecontestazioni_SegnalazioniContestazioni
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'CANADAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni', N'U') IS NULL
BEGIN
    EXEC CANADAPQ.usp_Create_Segnalazioniecontestazioni_SegnalazioniContestazioni;
    EXEC CANADAPQ.usp_AddIndexes_Segnalazioniecontestazioni_SegnalazioniContestazioni;
END;

TRUNCATE TABLE CANADAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni;

MERGE INTO CANADAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni AS TGT
USING CANADAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioniView (nolock) AS SRC
...
OUTPUT
    ...
    'CANADAPQ.Segnalazioniecontestazioni_SegnalazioniContestazioni' AS full_olap_table_name,
