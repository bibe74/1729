...
CREATE PROCEDURE IRDP.usp_Merge_DataTurno_DataTurno
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID(N'IRDP.DataTurno_DataTurno', N'U') IS NULL
BEGIN
    EXEC IRDP.usp_Create_DataTurno_DataTurno;
    EXEC IRDP.usp_AddIndexes_DataTurno_DataTurno;
END;

MERGE INTO IRDP.DataTurno_DataTurno AS TGT
USING IRDP.DataTurno_DataTurnoView (nolock) AS SRC
...
OUTPUT
    ...
    'IRDP.DataTurno_DataTurno' AS full_olap_table_name,
