...
ALTER TABLE [AX2009].[CUSTINVOICEJOUR_FattureCliente]
    ADD CONSTRAINT [PK_CUSTINVOICEJOUR_FattureCliente] PRIMARY KEY CLUSTERED ([DATAAREAID] ASC, [INVOICEDATE] ASC, [INVOICEID] ASC, [SALESID] ASC, [NUMBERSEQUENCEGROUP] ASC, [RECID] ASC);
GO

CREATE UNIQUE NONCLUSTERED INDEX [IX_AX2009_CUSTINVOICEJOUR_FattureCliente_RECID]
    ON [AX2009].[CUSTINVOICEJOUR_FattureCliente]([RECID] ASC);
GO
