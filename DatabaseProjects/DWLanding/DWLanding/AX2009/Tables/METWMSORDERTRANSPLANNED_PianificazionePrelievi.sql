...
ALTER TABLE [AX2009].[METWMSORDERTRANSPLANNED_PianificazionePrelievi]
    ADD CONSTRAINT [PK_METWMSORDERTRANSPLANNED_PianificazionePrelievi] PRIMARY KEY CLUSTERED ([RECID] ASC);
GO
