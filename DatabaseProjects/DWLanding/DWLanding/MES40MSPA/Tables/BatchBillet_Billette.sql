CREATE TABLE [MES40MSPA].[BatchBillet_Billette] (
...
ALTER TABLE [MES40MSPA].[BatchBillet_Billette]
    ADD CONSTRAINT [PK_BatchBillet_Billette] PRIMARY KEY CLUSTERED ([BatchBilletID] ASC);
GO

CREATE NONCLUSTERED INDEX [IX_MES40MSPA_BatchBillet_Billette_StartTs_INCLUDE]
    ON [MES40MSPA].[BatchBillet_Billette]([StartTs] ASC)
