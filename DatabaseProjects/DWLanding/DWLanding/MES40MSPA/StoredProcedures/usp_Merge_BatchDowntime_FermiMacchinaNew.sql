...
CREATE PROCEDURE MES40MSPA.usp_Merge_BatchDowntime_FermiMacchinaNew
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MES40MSPA.BatchDowntime_FermiMacchinaNew', 'U') IS NULL
BEGIN
    EXEC MES40MSPA.usp_Create_BatchDowntime_FermiMacchinaNew;
    EXEC MES40MSPA.usp_AddIndexes_BatchDowntime_FermiMacchinaNew;
END;

MERGE INTO MES40MSPA.BatchDowntime_FermiMacchinaNew AS TGT
USING MES40MSPA.BatchDowntime_FermiMacchinaNewView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40MSPA.BatchDowntime_FermiMacchinaNew' AS full_olap_table_name,
