...
CREATE PROCEDURE MES40MSPA.usp_Merge_BatchBillet_Billette
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MES40MSPA.BatchBillet_Billette', 'U') IS NULL
BEGIN
    EXEC MES40MSPA.usp_Create_BatchBillet_Billette;
    EXEC MES40MSPA.usp_AddIndexes_BatchBillet_Billette;
END;

MERGE INTO MES40MSPA.BatchBillet_Billette AS TGT
USING MES40MSPA.BatchBillet_BilletteView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40MSPA.BatchBillet_Billette' AS full_olap_table_name,
