...
CREATE PROCEDURE MES40MSPA.usp_Merge_Batch_Lotti
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MES40MSPA.Batch_Lotti', 'U') IS NULL
BEGIN
    EXEC MES40MSPA.usp_Create_Batch_Lotti;
    EXEC MES40MSPA.usp_AddIndexes_Batch_Lotti;
END;

MERGE INTO MES40MSPA.Batch_Lotti AS TGT
USING MES40MSPA.Batch_LottiView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40MSPA.Batch_Lotti' AS full_olap_table_name,
