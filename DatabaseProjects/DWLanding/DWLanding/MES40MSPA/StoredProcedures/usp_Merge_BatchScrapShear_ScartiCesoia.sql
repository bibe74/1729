...
CREATE PROCEDURE MES40MSPA.usp_Merge_BatchScrapShear_ScartiCesoia
AS
BEGIN
SET NOCOUNT ON;

IF OBJECT_ID('MES40MSPA.BatchScrapShear_ScartiCesoia', 'U') IS NULL
BEGIN
    EXEC MES40MSPA.usp_Create_BatchScrapShear_ScartiCesoia;
    EXEC MES40MSPA.usp_AddIndexes_BatchScrapShear_ScartiCesoia;
END;

MERGE INTO MES40MSPA.BatchScrapShear_ScartiCesoia AS TGT
USING MES40MSPA.BatchScrapShear_ScartiCesoiaView (nolock) AS SRC
...
OUTPUT
    ...
    'MES40MSPA.BatchScrapShear_ScartiCesoia' AS full_olap_table_name,
